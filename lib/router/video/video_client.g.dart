...
class _VideoClient implements VideoClient {
  ...
  Future<GetVideoGradeCollectionResponse> getGradeCollection(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetVideoGradeCollectionResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<GetWatchHistoryResponse> getWatchHistory(
    offset,
    limit,
  ) async {
    const _extra = <String, dynamic>{};
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetWatchHistoryResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<PostVideoResponse> postVideo(
    videoId,
    postVideoRequest,
  ) async {
    const _extra = <String, dynamic>{};
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PostVideoResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
